            ...
            <div className="row justify-content-center">
                <div className="border border-white rounded m-3 p-3 col-lg-8 col-md-10 col-11">
                    ...
                    <div className="row">
                        ...
                        <div class="col-md-6 col-12 form-floating mb-3">
                            <input type="text" class="form-control" id="accessLevel" placeholder="" value={user !== null && user.accessLevel} readonly required />
                            <label class="form-label ms-2">Access Level</label>
                        </div>

                        <div class="col-md-6 col-12 form-floating mb-3">
                            <input type="text" class="form-control" id="jobTitle" placeholder="" value={user !== null && user.jobTitle} readonly required />
                            <label class="form-label ms-2">Job Title</label>
                        </div>

                        <div class="col-md-6 col-12 form-floating mb-3">
                            <input type="text" class="form-control" id="email" placeholder="" value={user !== null && user.email} readonly required />
                ...
                <div className="row justify-content-center">
                    <div className="border border-white rounded m-3 p-3 col-lg-8 col-md-10 col-11">
                        ...
                        <div className="row">
                            ...
                            <div class="col-md-6 col-12 form-floating mb-3">
                                <input type="text" class="form-control" id="phone1" placeholder="" defaultValue={user !== null && user.phone[0]} disabled required />
                                <label class="form-label ms-2">Phone 1</label>
                            </div>

                            <div class="col-md-6 col-12 form-floating mb-3">
                                <input type="text" class="form-control" id="phone2" placeholder="" defaultValue={user !== null && user.phone[1]} disabled required />
